...
from app.services.code_analysis.graph_candidates import GraphCandidate, GraphValidationIssue
...
class RepositoryState:
    ...
    graph_validation_issues: list[GraphValidationIssue] = field(default_factory=list)
    failed_files: int = 0
