...
from app.services.chat.conversation_memory import ConversationSummaryRecord, ConversationTranscriptRecord
from app.services.chat.trace_persistence import AssistantTraceReplay, PersistedAssistantTurn
...
class RepositoryStorePort(Protocol):
    ...
    def list_conversations(self, repository_id: str, limit: int) -> tuple[ConversationSummaryRecord, ...]: ...
    ...
    def get_agent_trace(self, repository_id: str, trace_id: str) -> AssistantTraceReplay | None: ...
