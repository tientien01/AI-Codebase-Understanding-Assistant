...
| Evaluation UI/backend | Partial internal backend | Deterministic internal runner validates `evaluation-case/v1`, computes retrieval/insufficient-evidence metrics and exports checksummed JSON; API/UI, answer judging, provider runs, thresholds and load evidence remain absent |
