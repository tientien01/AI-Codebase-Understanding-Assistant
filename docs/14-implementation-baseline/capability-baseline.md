...
Authority: Current source plus the 241-test suite
...
| Assistant | Partial bounded baseline | Immutable typed workflow/tool contracts and an exact/hybrid allowlist enforce deterministic routing, call/time/context budgets, cancellation, deduplication and safe failures before validated selected context; no multi-round sufficiency repair, claim/citation validator, persistent structured trace or accepted agent threshold |
