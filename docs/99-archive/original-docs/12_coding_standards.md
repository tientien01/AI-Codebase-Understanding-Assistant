...
- Keep parser output aligned with `15_parser_output_schema.md`.
...
## Agent Workflow and LangGraph

- LangGraph can orchestrate the workflow, but domain steps must be plain testable functions/classes.
