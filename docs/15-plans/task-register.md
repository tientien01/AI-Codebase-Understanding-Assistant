...
| UI-025 | Final UI polish for project management and assistant workflows | AGT-006,AGT-007,UI-024 | Focused tests, lint, typecheck, build, diff hygiene, and owner runtime review |
